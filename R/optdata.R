...
download_opt_data <- function(dl_from = c("rcmd.org", "github_fsf_release"),
  ...
  local_filenames_subject1 <- list(
    c(base_path_subject1, "label", "lh.aparc.a2009s.annot"),
  ...
  local_filenames_cifti <- list(
    c(base_path_cifti, "Conte69.L.inflated.32k_fs_LR.surf.gii"),
  ...
  base_path_dwi <- c("dwi")
  local_filenames_dwi <- list(
    c(base_path_dwi, "tracks.tck"),
  ...
  md5sums_subject1 <- c(
    "099e738654aedc71cd580256f4f3914b",
  ...
  md5sums_cifti <- c(
    "5aa64e146839f0332b5744d0a6e7f737",
  ...
  md5sums_dwi <- c(
    "7d55d826fc4b7f06c4c0c7147d85990d",
  ...
  ext_urls_cifti <- c(
    "cifti/Conte69.L.inflated.32k_fs_LR.surf.gii",
