...
#'
#' @param nifti_img instance of class `nifti` from the `oro.nifti` package, or a path to a NIFTI file as a character string.
#'
...
fs.volume.from.oro.nifti <- function(nifti_img) {
  ...
  if (requireNamespace("oro.nifti", quietly = TRUE)) {
    ...
    fsvol_data = rotate3D(drop(fsvol_data), axis=1L, degrees = 90L);
