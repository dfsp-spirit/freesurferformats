...
### Hint: Further image processing and visualization
...
That's all the information you can get from an annotation file. Feel free to combine it with morphometry data obtained via `read.fs.curv` or `read.fs.mgh` to compute stuff like the average thickness in a region.
