...
test_that("A surface file in FreeSurfer binary format can be read using read_nisurface", {
...
test_that("A surface file in FreeSurfer ASCII format can be read using read_nisurface", {
